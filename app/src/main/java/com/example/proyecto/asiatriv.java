...
public class asiatriv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asiatriv); // Inflar el diseño correcto
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (respuestasEnviadas) {
                    ...
                    new AlertDialog.Builder(asiatriv.this)
                            .setTitle("Siguiente")
                    ...
                    Intent intent = new Intent(asiatriv.this, carga.class);
