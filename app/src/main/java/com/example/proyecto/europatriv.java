...
public class europatriv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_europatriv); // Inflar el diseño correcto
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (respuestasEnviadas) {
                    ...
                    new AlertDialog.Builder(europatriv.this)
                            .setTitle("Siguiente")
                    ...
                    Intent intent = new Intent(europatriv.this, carga.class);
    ...
    private void mostrarResultado() {
        ...
        if (radioGroup1.getCheckedRadioButtonId() == R.id.radioButton1c) correctas++;
        if (radioGroup2.getCheckedRadioButtonId() == R.id.radioButton2b) correctas++;
        if (radioGroup3.getCheckedRadioButtonId() == R.id.radioButton3c) correctas++;
